...
start "Educore Governance Server" "%SCRIPT_DIR%framework_control\Scripts\python.exe" "%SCRIPT_DIR%educore_enterprise_backend.py" 8000
...
start "Open WebUI" "%SCRIPT_DIR%.openwebui_env\Scripts\open-webui.exe" serve --port 3000

echo ==============================================================================
echo   EduCore Enterprise Platform Online!
echo   - Backend API: http://127.0.0.1:8000/v1
echo   - Open WebUI:  http://127.0.0.1:3000
echo   - Audit Log:   %SCRIPT_DIR%aims_rag_audit.jsonl
echo ==============================================================================
pause
