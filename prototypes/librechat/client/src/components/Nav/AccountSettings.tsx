  ...
  return (
    <Menu.MenuProvider placement={collapsed ? 'right-end' : undefined}>
      ...
      >
        ...
        {((user?.role || '').toUpperCase() === 'ADMIN' || startupConfig?.adminPanelURL) && (
          <Menu.MenuItem
            onClick={() => navigate('/admin')}
            className="select-item text-sm font-medium"
            data-testid="nav-admin-console"
          >
            <ShieldCheck className="icon-md text-emerald-500" aria-hidden="true" />
